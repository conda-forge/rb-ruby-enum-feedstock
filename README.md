...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-ruby-enum-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7697&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-ruby-enum-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-ruby-enum` can be installed with:

```
conda install rb-ruby-enum
```

It is possible to list all of the versions of `rb-ruby-enum` available on your platform with:
